    ...
    def put(self, schedule_id):
        ...
        try:
            ...
            if 'departure_time' in data:
                schedule.departure_time = datetime.strptime(data['departure_time'], '%Y-%m-%d %H:%M:%S')
            if 'arrival_time' in data:
                schedule.arrival_time = datetime.strptime(data['arrival_time'], '%Y-%m-%d %H:%M:%S')
            if 'date' in data:
